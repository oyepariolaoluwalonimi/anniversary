...
function bg(){
    document.getElementById("bg").style.backgroundImage="url(nav-img-1.jpg)"

}
function bh(){
    document.getElementById("bg").style.backgroundImage="url(nav-img-2.jpg)"

}
function bj(){
    document.getElementById("bg").style.backgroundImage="url(nav-img-3.jpg)"

}
function bk(){
    document.getElementById("bg").style.backgroundImage="url(nav-img-4.jpg)"
...
function preview(pic){
    ...
    document.getElementById("pars").innerHTML = "";
}
function undo(){
